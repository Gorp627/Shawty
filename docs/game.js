...
class Game {
    ...
    initializeNetwork() {
        ...
        if (typeof Network !== 'undefined' && typeof Network.init === 'function') {
            try { Network.init(); console.log("Net init ok."); return true;
            } catch (e) { console.error("Net Init Err:", e); if(typeof stateMachine !== 'undefined') stateMachine.transitionTo('loading', { message: `Net Fail! ${e.message}`, error: true }); return false; }
        } else { console.error("Network missing!"); if(typeof stateMachine !== 'undefined') stateMachine.transitionTo('loading', { message: `Net Load Fail!`, error: true }); return false; }
    }
    ...
    bindLoadManagerListeners() {
        ...
        loadManager.on('ready', () => {
            ...
            if (!this.mapMesh) { console.error("Map data missing!"); if(typeof stateMachine !== 'undefined') stateMachine.transitionTo('loading', { message: "Map Data Fail!", error: true }); return; }
    ...
    initializeManagers() {
        ...
        if(typeof UIManager === 'undefined'||typeof Input === 'undefined'||typeof stateMachine === 'undefined'||typeof loadManager === 'undefined'||typeof Network === 'undefined'||typeof Effects === 'undefined') {
             console.error("Mgr undef!"); if(typeof UIManager !== 'undefined' && UIManager?.showError) UIManager.showError("FATAL: Mgr Load!", 'loading'); return false;
        }
        try {
             ...
             console.error("Mgr Init Err:", e); if(typeof UIManager !== 'undefined' && UIManager?.showError) UIManager.showError(`FATAL: Mgr Setup! ${e.message}`, 'loading'); return false;
         }
    }
