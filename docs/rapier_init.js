// docs/rapier_init.js (REGENERATED v2 - Uses Skypack)

// Dynamically import the Rapier library using the correct CDN
// Skypack provides pre-built ES Module versions suitable for direct browser use.
import RAPIER from 'https://cdn.skypack.dev/@dimforge/rapier3d-compat';

console.log("[Rapier Init] Starting Rapier WASM initialization via Skypack...");
